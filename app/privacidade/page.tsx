...
export const metadata: Metadata = {
  ...
  description: 'Política de privacidade e tratamento de dados pessoais da pierrondi.dev, em conformidade com a LGPD.',
  alternates: {
  ...
  return (
    <main className={styles.shell}>
      ...
      <p className={styles.lead}>
        Atualizada em abril de 2026 · Em conformidade com a LGPD.
      </p>
      ...
      <div className={styles.prose}>
        ...
        <ul>
          ...
          <li>Operar integrações oficiais de publicação ou gestão de conteúdo, sempre mediante consentimento e configuração explícita.</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>TikTok</strong> — autenticação OAuth e APIs oficiais quando você conecta sua conta</li>
        </ul>
