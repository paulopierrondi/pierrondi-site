...
const staticRoutes: Array<{
  ...
  { path: '/sobre', priority: 0.98, changeFrequency: 'monthly' },
  { path: '/portfolio', priority: 0.96, changeFrequency: 'monthly' },
  { path: '/precos', priority: 0.95, changeFrequency: 'monthly' },
  ...
  { path: '/en', priority: 0.81, changeFrequency: 'monthly' },
