...
const services: Record<AtuacaoLang, Service[]> = {
  ...
  en: [
    ...
    },
    {
      ...
      outcome: 'Now Assist and AI Agents connected to CMDB, CSDM, and business outcomes.',
      ...
      items: [
        ...
        { k: '02', t: 'CSDM, CMDB, and Service Graph as the context foundation.' },
        { k: '03', t: 'Governance, compliance, and audit trails.' },
    ...
    },
    {
      ...
      outcome: 'Registry, scheduler, handoffs, and runners that turn agents into auditable operations.',
      desc: 'I build the systems that make agents reliable: registry, scheduler, handoffs, memory, human gates, and runners. The goal is to move execution out of loose chat and into workflows with evidence trails.',
      items: [
        { k: '01', t: 'Agent and workflow registry and scheduler.' },
        { k: '02', t: 'Human-in-the-loop review and explicit approvals.' },
    ...
    },
    {
      ...
      title: 'Narrative that moves the board, architecture, and delivery.',
      ...
      items: [
        ...
        { k: '02', t: 'Workshops and enablement for technical leaders.' },
