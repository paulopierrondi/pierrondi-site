...
export default function TermosPage() {
  return (
    <main className={styles.shell}>
      ...
      <h1 className={styles.h1}>Termos de Serviço.</h1>
      ...
      <div className={styles.prose}>
        ...
        <p>
          A configuração de App Store Connect pode ser gratuita quando contratada como escopo pontual. Taxa anual da Apple, custos de contas, ferramentas, anúncios e quaisquer cobranças de terceiros são pagos diretamente pelo cliente.
        </p>
        <p>
        ...
        <p>
          Integrações com TikTok e outros provedores dependem de OAuth, permissões oficiais, disponibilidade das APIs e políticas de cada plataforma. A pierrondi.dev usa essas integrações apenas quando o usuário autoriza e configura a conexão.
        </p>
