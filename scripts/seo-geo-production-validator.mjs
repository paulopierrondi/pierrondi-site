  ...
  return Promise.all([
    bodyCheck({
      ...
      mustInclude: [
        ...
        '<loc>https://www.pierrondi.dev/privacy</loc>',
        '<loc>https://www.pierrondi.dev/privacidade</loc>',
        '<loc>https://www.pierrondi.dev/terms</loc>',
        '<loc>https://www.pierrondi.dev/termos</loc>',
      ],
      mustNotInclude: [
        ...
        '<loc>https://www.pierrondi.dev/sprint</loc>',
        '/support</loc>',
      ],
    }),
    bodyCheck({
