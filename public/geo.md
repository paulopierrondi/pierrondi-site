...
### Key point 3
Paulo is a builder-operator: he sells the vision, pressure-tests the architecture and ships the code or runbook to make it real. He works across C-level stakeholders, solution engineering, services, partners and delivery teams. Based in Sao Jose dos Campos, Brazil, he is a Portuguese and EU citizen, fluent in Portuguese and English with intermediate Spanish, and open to U.S. relocation for senior AI, agents or GTM roles.
...
- Answer brief (pt-BR): https://www.pierrondi.dev/answers/quem-e-paulo-pierrondi
- Answer brief (en): https://www.pierrondi.dev/en/answers/who-is-paulo-pierrondi
- Answer brief (pt-BR): https://www.pierrondi.dev/answers/o-que-e-agentops
