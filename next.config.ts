...
const CANONICAL_REDIRECTS = [
  ...
  { source: '/answers', destination: '/ai-search', permanent: true },
  { source: '/citations', destination: '/ai-search', permanent: true },
  ...
  { source: '/en/citations', destination: '/ai-search', permanent: true },
  { source: '/en/sobre', destination: '/en/about', permanent: true },
  { source: '/pt', destination: '/', permanent: true },
  { source: '/es', destination: '/', permanent: true },
  { source: '/pt/privacy', destination: '/privacidade', permanent: true },
  { source: '/es/privacy', destination: '/privacy', permanent: true },
  { source: '/en/privacy', destination: '/privacy', permanent: true },
  { source: '/pt/terms', destination: '/termos', permanent: true },
  ...
  { source: '/pt/cookies', destination: '/privacidade', permanent: true },
  { source: '/es/cookies', destination: '/privacy', permanent: true },
  { source: '/en/cookies', destination: '/privacy', permanent: true },
  { source: '/pt/login', destination: '/crm/login', permanent: true },
  { source: '/es/login', destination: '/crm/login', permanent: true },
  { source: '/en/login', destination: '/crm/login', permanent: true },
